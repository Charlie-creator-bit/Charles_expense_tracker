        ...
        <div className="glass-card text-center p-8">
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 text-left">
            <div className="rounded-xl bg-slate-900/50 p-4 border border-slate-800">
              <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Security</p>
              <p className="text-sm font-medium text-slate-300">Level 4</p>
            </div>
            <div className="rounded-xl bg-slate-900/50 p-4 border border-slate-800">
        ...
        <div className="space-y-6">
          <section className="glass-panel p-6">
            <div className="mb-8 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-white">Financial Constraints</h3>
                <p className="text-[10px] text-slate-500">Set your maximum monthly expenditure limit</p>
              </div>
            </div>
          ...
          <section className="glass-panel p-6 border-rose-500/10 bg-rose-500/5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-white uppercase tracking-tight">Danger Zone</h3>
                <p className="text-[10px] text-slate-500">Irreversible node operations</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full rounded-xl bg-slate-800 px-4 py-3 text-xs font-bold text-white border border-slate-700 hover:bg-slate-700 transition-all"
              >
                Logout
              </button>
              <button
                ...
                disabled={isDeleting}
                className="w-full rounded-xl bg-rose-500/10 px-4 py-3 text-xs font-bold text-rose-500 border border-rose-500/20 hover:bg-rose-500 hover:text-white transition-all disabled:opacity-50"
              >
